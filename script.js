...
const sectionBoxDescription1 = document.querySelector("#sectionBoxDescription1")
const sectionBoxDescription2 = document.querySelector("#sectionBoxDescription2")
const sectionBoxDescription3 = document.querySelector("#sectionBoxDescription3")
const sectionBoxDescription4 = document.querySelector("#sectionBoxDescription4")
const sectionBoxDescription5 = document.querySelector("#sectionBoxDescription5")
const sectionBoxDescription6 = document.querySelector("#sectionBoxDescription6")
const sectionBoxDescription7 = document.querySelector("#sectionBoxDescription7")
const sectionBoxDescription8 = document.querySelector("#sectionBoxDescription8")
...
function line_height() {
  if(scrollY > 1100) {
    line.style = "height: " + (scrollY - 1549) + "px;"
      // line.style = "height: " + (scrollY - window.innerHeight * 1.8) + "px;"
