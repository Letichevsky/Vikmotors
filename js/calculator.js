...
const registrationOurCompanyAmount = document.querySelector("#registrationOurCompanyAmount")
...
btnCalculate.onclick = () => {
    ...
    roadToTheCar = km * 1.2
    registrationOurCompany = (chekToggle1 === true) ? Math.round(carPrice * 0.03) : 0
    carRegistration = (chekToggle2 === true) ? 250 : 0
    getCar = (chekToggle3 === true) ? 200 : 0
    ...
    registrationOurCompanyAmount.innerHTML = "€ " + Math.round(registrationOurCompany)
    ...
    let total = ( Math.round(carPrice) +  Math.round(servicePrice) +  Math.round(roadToTheCar) +  Math.round(registrationOurCompany) +  Math.round(carRegistration) +  Math.round(getCar)) -  Math.round(cashBack)
